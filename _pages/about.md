...
- **General Pre-training Corpora Refinement:** Co-initiator of [ProX](https://github.com/GAIR-NLP/ProX)([ICML 2025](https://arxiv.org/abs/2409.17115v2)), a scalable framework that leverages tiny language models to automatically refine large-scale corpora, along with refined byproducts, such as [FineWeb-Pro (100B tokens)](https://huggingface.co/datasets/gair-prox/FineWeb-pro) and [DCLM-Pro (>500B tokens)](https://huggingface.co/datasets/gair-prox/DCLM-pro). Check [Huggingface](https://huggingface.co/gair-prox) for more releases.
